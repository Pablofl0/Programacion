...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        // Estruturas de datos
        ArrayList<Producto> produtos = new ArrayList<Producto>();
        ArrayList<Componente> componhentes = new ArrayList<Componente>();
        ...
        MemoriaRam corsair = new MemoriaRam("Corsair", "Corsair Vengeance", 139.98, 6, 16);
        produtos.add(acer);
